...
const projectShowcaseItems = [
  ...
  },
  {
    ...
    brief: "为 500mL 原叶茉莉绿茶建立清晰的无糖品牌主张，连接包装识别、口感表达与日常消费场景。",
    response: "以零糖真茶香为核心定位，固定产品包装母版，再将利益、口感、饮用动作和零售场景组织为完整上市内容。",
  ...
  {
    index: "03B",
    title: "青岚焙香乌龙：双味产品线扩展",
    english: "QINGLAN OOLONG GROWTH SYSTEM",
    category: "食品饮料 / 概念品牌",
    categoryEnglish: "BEVERAGE COMMERCE",
    year: "2026",
    image: "/assets/projects/qinglan-tea/qinglan-oolong-launch-hero.webp",
    alt: "青岚茶事原叶茉莉绿茶与焙香乌龙茶双味产品主视觉",
    backdrop: "QINGLAN",
    accent: "#a77b5b",
    introTheme: {
      surface: "#dddcd3",
      ...
      accent: "#76523b",
      rule: "#927762",
      shadow: "rgba(45, 36, 28, 0.24)",
    },
    summary: "以原叶茉莉绿茶建立品牌基线，再扩展焙香乌龙，通过双味定位、包装家族、零售导航、组合销售与动态内容完成产品线增长。",
    brief: "青岚茶事需要从单一清香口味走向双 SKU 选择，同时保留统一品牌识别，并让两种风味在货架、餐桌和社交场景中承担不同消费理由。",
    response: "建立共享的透明 PET 瓶型、标签网格与信息层级，再用瓶盖、茶汤、植物线描和场景语义区分花香轻与焙香深，形成可持续扩展的双味资产系统。",
    role: "AI Art Direction / FMCG Brand System",
    scope: "概念品牌产品线扩展与上市内容",
    ...
    gallery: [
      ...
      { src: "/assets/projects/qinglan-tea/qinglan-oolong-pour.webp", alt: "青岚茶事焙香乌龙倒茶与琥珀茶汤", layout: "wide" },
      { src: "/assets/projects/qinglan-tea/qinglan-oolong-family-master.webp", alt: "青岚茶事双 SKU 产品家族母版", layout: "wide" },
      { src: "/assets/projects/qinglan-tea/qinglan-oolong-retail-choice.webp", alt: "青岚茶事双味无糖茶冷柜选择场景", layout: "wide" },
      { src: "/assets/projects/qinglan-tea/qinglan-oolong-combo-case.webp", alt: "青岚茶事双味六瓶组合装", layout: "square" },
      { src: "/assets/projects/qinglan-tea/qinglan-oolong-meal-drinking.webp", alt: "都市女性在正餐场景中饮用焙香乌龙茶", layout: "wide" },
      { src: "/assets/projects/qinglan-tea/qinglan-oolong-social-choice.webp", alt: "年轻消费者分别选择青岚茶事两种风味", layout: "wide" },
    ],
  },
] as const;
...
// The visual work screen is intentionally curated independently from the
// recruiter-facing business-case taxonomy above. Changes here must never
// rewrite the commercial-case entrance cards.
const selectedWorkCollections = [
  {
    ...
    coverImages: ["/assets/projects/air-fryer/air-fryer-hero.webp"],
  ...
  },
  {
    ...
    coverImages: ["/assets/projects/glacier-cleanser/glacier-sunrise-wide.webp"],
...
const qinglanOolongCaseStudy = {
  context: [
    { label: "品牌阶段", value: "从原叶茉莉绿茶单品扩展为双味无糖茶产品线" },
    { label: "新增产品", value: "500mL 焙香乌龙茶，0 糖、0 脂、0 能量" },
    { label: "消费选择", value: "花香轻适合轻饮，焙香深承接更成熟的正餐与浓茶偏好" },
    { label: "内容范围", value: "包装家族、风味区分、货架导航、组合销售、真人饮用与动态短片" },
  ],
  skuRoles: [
    {
      name: "原叶茉莉绿茶",
      signal: "花香轻",
      detail: "竹青瓶盖、浅金茶汤与茉莉线描构成轻盈入口，服务清爽和日常轻饮。",
    },
    {
      name: "焙香乌龙茶",
      signal: "焙香深",
      detail: "赤铜瓶盖、琥珀茶汤与卷曲乌龙叶构成成熟风味，进入正餐和浓茶场景。",
    },
  ],
  fixedAnchors: ["透明方肩 PET 瓶型", "500mL 容量比例", "温米白标签网格", "青岚茶事品牌层级", "0 糖、0 脂、0 能量信息位置"],
  controlledDifferences: ["竹青与赤铜瓶盖", "浅金与琥珀茶汤", "茉莉与乌龙叶线描", "轻饮与正餐场景", "花香轻与焙香深文案"],
  commercialJourney: [
    {
      title: "货架选择",
      purpose: "用瓶盖和茶汤色快速区分两种风味，取瓶动作把产品家族连接到真实零售决策。",
      touchpoint: "零售导航",
      image: "/assets/projects/qinglan-tea/qinglan-oolong-retail-choice.webp",
      alt: "冷柜中按竹青与赤铜色区分的青岚茶事双味无糖茶",
      layout: "wide",
    },
    {
      title: "组合销售",
      purpose: "六瓶双味组合装把风味选择转化为家庭囤货和组合购买方案。",
      touchpoint: "商品组合",
      image: "/assets/projects/qinglan-tea/qinglan-oolong-combo-case.webp",
      alt: "青岚茶事原叶茉莉绿茶与焙香乌龙茶六瓶组合装",
      layout: "square",
    },
    {
      title: "正餐杯饮",
      purpose: "透明杯、真实茶汤和桌面双产品建立风味体验，让焙香乌龙进入成熟用餐场景。",
      touchpoint: "场景说服",
      image: "/assets/projects/qinglan-tea/qinglan-oolong-meal-drinking.webp",
      alt: "都市女性在正餐场景中饮用青岚茶事焙香乌龙茶",
      layout: "wide",
    },
    {
      title: "双味社交",
      purpose: "两位消费者各自选择一款茶，建立同品牌下不同口感偏好的社交关系。",
      touchpoint: "社交传播",
      image: "/assets/projects/qinglan-tea/qinglan-oolong-social-choice.webp",
      alt: "年轻消费者分别手持青岚茶事茉莉绿茶与焙香乌龙茶",
      layout: "wide",
    },
  ],
  motionClips: [
    {
      title: "冷柜聚焦",
      note: "从满陈列环境收束到冰镇主产品，保留稳定瓶型与清晰标签。",
      src: "/assets/projects/qinglan-tea/qinglan-oolong-film-cooler.mp4",
      poster: "/assets/projects/qinglan-tea/qinglan-oolong-film-cooler-poster.webp",
  ...
  qualityChecks: [
    { title: "家族一致", detail: "两款产品共享瓶型、容量、标签网格和品牌层级，不能成为两个无关品牌。" },
    { title: "风味可分", detail: "瓶盖、茶汤、植物图形与场景语义共同区分花香轻和焙香深。" },
    { title: "文字准确", detail: "品牌、口味与无糖信息逐字复核，不接受镜像、乱码和未定义功效。" },
    { title: "动作真实", detail: "取瓶、开盖、杯饮与对瓶饮用符合手部、液面和重力关系。" },
    { title: "渠道明确", detail: "货架、组合装、正餐和社交画面分别承担选择、购买、体验和传播职责。" },
    { title: "动态完整", detail: "冷柜聚焦、旋盖与饮用保持动作连续，产品外观和标签识别始终稳定。" },
  ],
  results: [
...
function selectedCaseWork(
  ...
  const collection = selectedWorkCollections.find((entry) => entry.id === collectionId);
...
function Nav() {
  ...
  const scheduleComponentEntry = (sectionId: string, target: number) => {
    ...
    if (!section) return;
    // Keep the clicked item active while smooth scrolling passes through
    // other sections. The observer would otherwise briefly overwrite it.
    navigationLock.current = sectionId;
    ...
    pendingEntryCleanup.current = () => {
      ...
      if (navigationLock.current === sectionId) navigationLock.current = null;
    };
  };
...
const oolongImageSizes: Record<string, readonly [number, number]> = {
  ...
  "qinglan-oolong-family-master.webp": [2400, 1340],
  "qinglan-oolong-retail-choice.webp": [2400, 1340],
...
function SelectedCaseViewer({ work, reduceMotion, onClose }: {
  ...
  const [collectionIndex, setCollectionIndex] = useState(() => {
    const index = selectedWorkCollections.findIndex((collection) => collection.id === work.caseRef?.collectionId);
    return index < 0 ? 0 : index;
  });
  const [projectIndex, setProjectIndex] = useState<number | null>(null);
  const collection = selectedWorkCollections[collectionIndex];
      ...
      <SelectedCollectionViewer
        ...
        onNavigate={(direction) => {
          ...
          setCollectionIndex((current) =>
            (current + direction + selectedWorkCollections.length) % selectedWorkCollections.length);
        }}
...
const selectedCollectionPrimary: Record<string, string> = {
  // The wide launch banner remains protected in the detail hero. This square
  // campaign key visual keeps both the product and its complete headline safe
  // inside the fixed portrait work frame.
  "SONA ARC ONE EARBUDS LAUNCH SYSTEM": "/assets/projects/sona-earbuds/sona-campaign-silence.webp",
  "AIR FRYER COMMERCE SYSTEM": "/assets/projects/air-fryer/air-fryer-work-card-v2.png",
  ...
  "GLACIER CLEANSER COMMERCE SYSTEM": "/assets/projects/glacier-cleanser/glacier-hero-portrait.webp",
  "LUMINOSE SERUM COMMERCE SYSTEM": "/assets/projects/serum/serum-dropper-kv.webp",
      ...
      >
        <header className="selected-collection-header">
          ...
          <nav aria-label="作品集合切换">
            <span>{String(currentIndex + 1).padStart(2, "0")} / {String(selectedWorkCollections.length).padStart(2, "0")}</span>
...
const curatedNonIdentityOutputs: VisualOutput[] = [
  ...
  { id: "yoga-material-feature", title: "贴合，不必平淡", project: "瑜伽套装", category: "commerce", shape: "standard", src: "/assets/projects/works-index/yoga-material-feature.jpg", alt: "瑜伽套装贴合结构细节" },
    { id: "serum-routine-feature", title: "玻尿酸 × 维C焕亮配方", project: "LUMINOSE", category: "commerce", shape: "tall", src: "/assets/projects/serum/serum-commerce-formula.webp", alt: "LUMINOSE 玻尿酸与维C焕亮配方信息" },
...
type ProjectShowcaseCollection = (typeof projectShowcaseCollections)[number] | (typeof selectedWorkCollections)[number];
    ...
    <div className="smart-case earbuds-case">
      <section className="case-capability-intro earbuds-capability" aria-labelledby="earbuds-capability-title">
        <header>
          ...
          <h3 id="earbuds-capability-title">从开盖的一刻，听见自己的节奏。</h3>
          <p>由充电仓开启、耳机升起到双耳展开，以连续镜头呈现金属切面与精密结构，再延展为功能主图和通勤场景。</p>
        </header>
      ...
      <section className="earbuds-calibration" aria-labelledby="earbuds-calibration-title">
        <header className="smart-case-heading">
          <h3 id="earbuds-calibration-title">完整轮廓，精密细节。</h3>
          <p>闭合、开盖与双耳独立状态展示整体轮廓，结构近景补充转轴、接口、触控面与耳帽细节。</p>
        </header>
      ...
      <section className="earbuds-film-sequence" aria-labelledby="earbuds-film-sequence-title">
        <header className="smart-case-heading">
          <h3 id="earbuds-film-sequence-title">四个状态，构成一段连续镜头。</h3>
      ...
      <section className="earbuds-material-story" aria-labelledby="earbuds-material-title">
        <div className="earbuds-material-copy">
          <h3 id="earbuds-material-title">靠近，才看清精密感。</h3>
      ...
      <section className="earbuds-wear-context" aria-labelledby="earbuds-wear-title">
        <header className="smart-case-heading">
          <h3 id="earbuds-wear-title">进入通勤，回到真实佩戴。</h3>
          <p>人物影像独立呈现站台与街道中的佩戴体验，用自然动作、头发与环境风表现耳机进入生活后的状态。</p>
        </header>
        <div className="earbuds-wear-grid">
          <figure className="is-portrait">
            <ZoomableProjectImage
              ...
              loading="lazy"
            />
            <figcaption>站台通勤 / 入耳尺度与自然佩戴。</figcaption>
          </figure>
          <figure className="is-wide">
            <ZoomableProjectImage
      ...
      <section className="smart-case-results earbuds-results" aria-labelledby="earbuds-results-title">
        <header>
          <div><h3 id="earbuds-results-title">一套上市内容，从产品片延展到商品页。</h3></div>
          <p>核心交付包括产品影像、连续关键帧、功能主图与跨比例渠道内容；延展系列进一步补充通勤、防护与佩戴场景。</p>
        </header>
        ...
        <p className="smart-case-conclusion">从精密结构到自然佩戴，以一致的产品识别连接动态叙事与上市传播。</p>
...
function QinglanOolongCaseStudy({
  ...
  return (
    <div className="smart-case qinglan-case qinglan-oolong-case">
      <section className="case-capability-intro qinglan-capability" aria-labelledby="qinglan-capability-title">
        <header>
          <span>FMCG BRAND SYSTEM</span>
          <h3 id="qinglan-capability-title">从单一花香心智，扩展为清晰的双风味选择</h3>
          <p>原叶茉莉绿茶建立品牌基线，焙香乌龙补充成熟浓茶方向。两款产品共享品牌资产，同时拥有各自的口感、场景和销售责任。</p>
        </header>
        <div className="qinglan-capability-media">
          <figure className="is-primary">
            <ZoomableProjectImage src="/assets/projects/qinglan-tea/qinglan-oolong-dual-flavor.webp" alt="花香轻与焙香深组成的青岚茶事双味无糖茶主视觉" onOpen={onImageOpen} loading="eager" />
          </figure>
          <figure>
            <ZoomableProjectImage src="/assets/projects/qinglan-tea/qinglan-oolong-pour.webp" alt="青岚茶事焙香乌龙茶倒入透明玻璃杯的茶汤画面" onOpen={onImageOpen} loading="eager" />
          </figure>
        </div>
      </section>
      ...
      <section className="qinglan-expansion-context" aria-labelledby="qinglan-case-context-title">
        <header className="smart-case-heading">
          ...
          <p>产品线扩展从品牌共同点开始，再让口味差异进入包装、场景和渠道。</p>
        </header>
        <div className="qinglan-expansion-context-layout">
          <figure>
            <ZoomableProjectImage
              src="/assets/projects/qinglan-tea/qinglan-oolong-family-master.webp"
              alt="青岚茶事原叶茉莉绿茶与焙香乌龙茶双 SKU 产品家族母版"
              onOpen={onImageOpen}
              loading="eager"
            />
            <figcaption>双 SKU 产品母版统一瓶型、比例、标签网格与品牌层级。</figcaption>
          </figure>
          <dl>
            {qinglanOolongCaseStudy.context.map((item) => (
              <div key={item.label}>
                <dt>{item.label}</dt>
                <dd>{item.value}</dd>
              </div>
        ...
        <div className="qinglan-growth-grid">
          {[0, 2].map((start) => (
            <div className="qinglan-growth-row" key={start}>
              {qinglanOolongCaseStudy.commercialJourney.slice(start, start + 2).map((scene) => (
          ...
          {qinglanOolongCaseStudy.motionClips.map((clip) => (
            <figure key={clip.src}>
              <PortfolioVideo
                ...
                scrollRoot={scrollRoot}
              />
              <figcaption><strong>{clip.title}</strong><span>{clip.note}</span></figcaption>
            </figure>
          ))}
        </div>
      </section>

      <section className="qinglan-control-system" aria-labelledby="qinglan-control-title">
        <header className="smart-case-heading">
          <h3 id="qinglan-control-title">先定义共性，再控制差异</h3>
          <p>产品家族依靠固定锚点保持同一身份，受控变量负责完成风味区分。</p>
        </header>
        <div className="qinglan-control-grid">
          <article>
            <strong>品牌固定锚点</strong>
            <ul>{qinglanOolongCaseStudy.fixedAnchors.map((item) => <li key={item}>{item}</li>)}</ul>
          </article>
          <article>
            <strong>口味受控差异</strong>
            <ul>{qinglanOolongCaseStudy.controlledDifferences.map((item) => <li key={item}>{item}</li>)}</ul>
          </article>
        </div>
      </section>
      ...
      <section className="qinglan-case-results" aria-labelledby="qinglan-results-title">
        <header>
          ...
          <h3 id="qinglan-results-title">可扩展的双 SKU 上市资产系统</h3>
          <p>交付范围覆盖产品家族、风味导航、渠道销售、真人场景与动态内容，以实际资产呈现项目结果。</p>
        </header>
        <div className="qinglan-result-grid">
          {qinglanOolongCaseStudy.results.map((result) => (
        ...
        <div className="qinglan-data-provenance">
          <article>
            <strong>品牌资产</strong>
            <p>一套瓶型、标签网格和品牌层级承接两种风味，后续口味可以沿同一规则继续扩展。</p>
          </article>
          <article>
            <strong>动态资产</strong>
          ...
          <article>
            <strong>项目边界</strong>
            <p>自主命题概念品牌，包装、内容与渠道设计用于展示快消产品线扩展和上市能力。</p>
          </article>
        </div>
        <p className="smart-case-conclusion">输出覆盖品牌架构、渠道销售、真人场景与动态内容，形成可继续扩展的快消新品内容基础。</p>
      </section>
    </div>
  );
}
...
function AILabListItem({
  ...
  // the section is almost out of view.
  const start = 0.06 + itemIndex * 0.035;
